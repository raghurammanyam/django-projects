...
SECRET_KEY = '_80y9jtn3p(4v+*#^)13v0#iec*q(@f_#5h&749n%nz0yfdd3@'
...
HAYSTACK_CONNECTIONS = {
             'default': {
                   'ENGINE': 'MainApp.backends.ConfigurableElasticSearchEngine',
                   'URL': 'http://localhost:9200/',
                   'INDEX_NAME': 'blogpost_index',
                   'EXCLUDED_INDEXES': [
...
#HAYSTACK_SIGNAL_PROCESSOR = 'haystack.signals.RealTimeSingalProcessor'
