...
from onorapp.Controllers.xlsregister import register_xls
from onorapp.Controllers.xlsnewsreader import newsreader_xls
from onorapp.Controllers.News import CreateGetNews,deletenews
...
urlpatterns=[
     ...
     url(r'^register.xls',register_xls),
     url(r'^newsreader.xls',newsreader_xls),
     url(r'^forgotpassword',ForgotPassword.as_view()),
     url(r'^news/(?P<id>\d+)$',deletenews.as_view()),
     url(r'^news',CreateGetNews.as_view())
